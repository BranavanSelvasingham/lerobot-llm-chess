...
For focused review of future gripper-reference tuning changes, run the standalone before/after smoke instead of changing the canonical profile or rerunning the full suite first:
