...
`source_intake_status`, `source_intake_action_ids`, recommended candidate
path/root context, command templates, and false authority flags for the first
reviewed-model-source acquisition gate.
