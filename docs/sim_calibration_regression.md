...
- `smoke_sim_so101_model_source_inventory.py` records deterministic repo-local SO-101 model-source inventory evidence, candidate/provenance/authority counts, source-authority gate status/blockers, review-packet JSON/CSV intake, and explicit missing-authoritative-model diagnostics before contract or IK checks.
