...
the matrix itself as reviewed physical SO-101 evidence. The workflow asserts the
motion-authority fields so hardware-free fixture motion remains labeled as
