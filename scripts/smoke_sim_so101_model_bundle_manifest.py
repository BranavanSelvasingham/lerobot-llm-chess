...
def build_summary(
    ...
    summary = {
        ...
        "ready_for_model_backed_ik": ready,
        "model_authority": model_authority,
        "observed_evidence_is_physical_so101_authority": physical_authority_ready,
        "observed_evidence_is_policy_training_authority": False,
        "development_fixture_evidence_not_physical_so101_truth": not physical_authority_ready,
