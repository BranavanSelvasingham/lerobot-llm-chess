...
def case_specs(fixtures: dict[str, Path]) -> list[dict[str, Any]]:
    return [
        ...
        {
            "case_id": "generated_reviewed_contract_motion_checked",
            ...
            "expect": {
                ...
                "hardware_free_fixture_motion_checked": False,
                "motion_evidence_not_physical_so101_authority": False,
                "downstream_handoff_status": "physical_reviewed_mujoco_handoff_ready",
                "downstream_handoff_ready": True,
                "fixture_handoff_ready_not_physical_so101_authority": False,
                "ready_handoff_has_open_work": False,
                "ready_handoff_open_work_missing_inputs": [],
                "ready_handoff_open_work_pending_action_ids": [],
            },
        },
...
def write_readme(path: Path, summary: dict[str, Any]) -> None:
    lines = [
        ...
        "Generated reviewed-contract caveat: `generated_reviewed_contract_motion_checked` covers the physical-authority contract branch with generated matrix data; it is not a reviewed physical SO-101 asset.",
        "",
        "## Cases",
        "",
    ...
    lines.extend(
        [
            ...
            "- The generated reviewed-contract case may set `physical_reviewed_model_motion_checked` for branch coverage, but the matrix summary remains non-authority.",
...
def main() -> int:
    ...
    summary = {
        ...
        "limitations": [
            ...
            "The generated reviewed-contract case covers the positive physical-authority code path with generated matrix data; it is not a reviewed physical SO-101 asset.",
