...
def build_ready_summary(
    *,
    ...
    summary = {
        ...
        "observed_evidence_is_physical_so101_authority": motion_authority_summary[
            "physical_reviewed_model_motion_checked"
        ],
        "observed_evidence_is_policy_training_authority": False,
        "development_fixture_evidence_not_physical_so101_truth": not motion_authority_summary[
            "physical_reviewed_model_motion_checked"
        ],
        "development_fixture_evidence_not_policy_training_truth": True,
        "physical_so101_model_authority_ready": physical_authority_ready,
...
def write_readme(path: Path, summary: dict[str, Any], rows: list[dict[str, Any]]) -> None:
    lines = [
        ...
        f"- `observed_evidence_is_physical_so101_authority`: `{str(summary.get('observed_evidence_is_physical_so101_authority')).lower()}`",
        f"- `observed_evidence_is_policy_training_authority`: `{str(summary.get('observed_evidence_is_policy_training_authority')).lower()}`",
        f"- `development_fixture_evidence_not_physical_so101_truth`: `{str(summary.get('development_fixture_evidence_not_physical_so101_truth')).lower()}`",
        f"- `development_fixture_evidence_not_policy_training_truth`: `{str(summary.get('development_fixture_evidence_not_policy_training_truth')).lower()}`",
